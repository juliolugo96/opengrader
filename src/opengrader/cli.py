...
def run_command(
    ...
    try:
        ...
        result = grade_assignment(assignment, submissions, runner, runner_name)
    ...
    console.print(f"\nResults: [cyan]{json_path}[/] and [cyan]{markdown_path}[/]")
...
def _print_summary(result: GradingResult) -> None:
    ...
    for submission in result.submissions:
        status = "[green]PASS[/]" if submission.passed else "[red]FAIL[/]"
        table.add_row(
